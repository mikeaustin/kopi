...
function peg$parse(input, options) {
  ...
  function peg$parsePrimitiveArrayPattern() {
    var s0;
  ...
  function peg$parseArrayPattern() {
    ...
    if (s0 === peg$FAILED) {
      ...
      if (s1 !== peg$FAILED) {
        s2 = peg$parse_();
        if (s2 !== peg$FAILED) {
          s3 = peg$parsePrimitiveArrayPattern();
          if (s3 !== peg$FAILED) {
            s4 = [];
            s5 = peg$currPos;
            s6 = peg$parse_();
            if (s6 !== peg$FAILED) {
              ...
              if (s7 !== peg$FAILED) {
                s8 = peg$parse_();
                if (s8 !== peg$FAILED) {
                  s9 = peg$parsePrimitiveArrayPattern();
                  if (s9 !== peg$FAILED) {
                    s6 = [s6, s7, s8, s9];
                    s5 = s6;
                  } else {
