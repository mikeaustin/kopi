...
function peg$parse(input, options) {
  ...
  var peg$e26 = peg$otherExpectation("ast-literal");
  ...
  var peg$f9 = function(operator, argumentExpression) {
      return {
  ...
  var peg$f10 = function(fieldName, head, tail) {
  ...
  var peg$f14 = function(key, head, tail) {
      return {
        type: 'DictLiteral',
  ...
  var peg$f21 = function(ident, parameterPattern) {
      return {
  ...
  var peg$f26 = function(identifier, defaultExpression) {
    return {
      type: 'IdentifierPattern',
      name: identifier.name,
