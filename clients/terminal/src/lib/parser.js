...
function peg$parse(input, options) {
  ...
  var peg$e19 = peg$otherExpectation("ast-literal");
  ...
  var peg$f7 = function(operator, argumentExpression) {
      return {
  ...
  var peg$f10 = function(statements) {
    return statements;
  };
  ...
  var peg$f18 = function(identifier, defaultExpression) {
    return {
      type: 'IdentifierPattern',
      name: identifier.name,
  ...
  function peg$parseAssignment() {
    ...
    s0 = peg$currPos;
    s1 = peg$parseAssignmentIdentifierPattern();
    if (s1 !== peg$FAILED) {
      s2 = peg$parse_();
