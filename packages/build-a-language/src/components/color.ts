...
type Grape = 'grape-0' | 'grape-1' | 'grape-2' | 'grape-3' | 'grape-4' | 'grape-5' | 'grape-6' | 'grape-7' | 'grape-8' | 'grape-9';
type Violet = 'violet-0' | 'violet-1' | 'violet-2' | 'violet-3' | 'violet-4' | 'violet-5' | 'violet-6' | 'violet-7' | 'violet-8' | 'violet-9';
type Indigo = 'indigo-0' | 'indigo-1' | 'indigo-2' | 'indigo-3' | 'indigo-4' | 'indigo-5' | 'indigo-6' | 'indigo-7' | 'indigo-8' | 'indigo-9';
type Blue = 'blue-0' | 'blue-1' | 'blue-2' | 'blue-3' | 'blue-4' | 'blue-5' | 'blue-6' | 'blue-7' | 'blue-8' | 'blue-9';
type Cyan = 'cyan-0' | 'cyan-1' | 'cyan-2' | 'cyan-3' | 'cyan-4' | 'cyan-5' | 'cyan-6' | 'cyan-7' | 'cyan-8' | 'cyan-9';
...
type Theme = 'theme-content' | 'theme-panel' | 'theme-divider';

type Color = Theme | Primary | White | Black | Gray | Red | Pink | Grape | Violet | Indigo | Blue | Cyan | Teal | Green | Lime | Yellow | Orange;
