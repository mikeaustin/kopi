...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c63 = function(ident) {
            return new IdentifierPattern({ name: ident.name });
          },
      peg$c64 = function(ident, params) {
      ...
      peg$c67 = function(ident, pattern) {
            return new ConstructorPattern({ name: ident.name, pattern });
          },
      peg$c68 = function(ident, init) {
      ...
      peg$c73 = function(name) { return new Identifier({ name: name[0] + name[1].join('') }); },
      peg$c74 = peg$otherExpectation("number"),
      peg$c75 = /^[0-9]/,
      peg$c76 = peg$classExpectation([["0", "9"]], false, false),
      peg$c77 = function(value) { return new NumericLiteral({ value: Number(value.join('')) }); },
      peg$c78 = peg$otherExpectation("string"),
      peg$c79 = "\"",
      peg$c80 = peg$literalExpectation("\"", false),
      peg$c81 = /^[^"]/,
      peg$c82 = peg$classExpectation(["\""], true, false),
      peg$c83 = function(value) { return new StringLiteral({ value: value.join('') }); },
      peg$c84 = "'(",
      peg$c85 = peg$literalExpectation("'(", false),
      peg$c86 = function(exprs) {
