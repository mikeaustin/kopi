...
function peg$parse(input, options) {
    ...
    var peg$f0 = function (head, tail) {
        return {
            ...
            statements: tail.reduce((statements, [, , statement]) => [...statements, statement], head ? [head] : []),
        };
    };
    ...
    var peg$f14 = function (fieldName, head, tail) {
        return !fieldName && tail.length === 0 ? head : {
            type: 'TupleExpression',
            expressionFields: tail.reduce((expressionFields, [, , , , expressionField]) => [...expressionFields, expressionField], [head]),
            expressionFieldNames: tail.reduce((fieldNames, [, , fieldName]) => [...fieldNames, fieldName && fieldName[0].name], [fieldName && fieldName[0].name]),
        };
    };
    ...
    var peg$f20 = function (head, tail) {
        return {
            type: 'ArrayLiteral',
            expressionElements: !head ? [] : tail.reduce((expressionElements, [, , , expressionElement]) => [...expressionElements, expressionElement], [head]),
        };
    };
    ...
    var peg$f22 = function (key, head, tail) {
        return {
            type: 'DictLiteral',
            expressionEntries: tail.reduce((expressionEntries, [, , key, , , expressionValue]) => [...expressionEntries, [key, expressionValue]], [[key, head]]),
        };
    };
    ...
    var peg$f26 = function (pattern, defaultExpression) {
        return Object.assign(Object.assign({}, pattern), { defaultExpression });
    };
    var peg$f27 = function (head, tail) {
        return head && tail.length === 0 ? head : {
            type: 'TupleLiteralPattern',
            patterns: !head ? [] : tail.reduce((patterns, [, , , pattern]) => [...patterns, pattern], [head]),
        };
    };
